...
//Onboarging View Strings
  ...
  static String onBoardingTitleThree = "onBoardingTitleThree".tr;
  static String onBoardingCaptionOne = "onBoardingCaptionOne".tr;
  static String onBoardingCaptionTwo = "onBoardingCaptionTwo".tr;
